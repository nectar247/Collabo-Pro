...
import HeroSplitScreen from '@/components/landing/hero/HeroSplitScreen';
import { useEffect, useState } from 'react';
import { getPopularSearches } from '@/lib/firebase/search';
import Link from 'next/link';
import { Home, ArrowLeft } from 'lucide-react';

export default function HeroPreview1() {
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm">Hero Concept 1: Split Screen Visual</p>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold text-primary mb-6">Concept 1: Split Screen Visual</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white rounded-xl p-6 shadow-md">
                  <h3 className="text-xl font-semibold text-primary mb-3">Key Features</h3>
                  <ul className="space-y-2 text-gray-700">
                    <li>✓ Animated stat counters</li>
                    <li>✓ Split layout with visual hierarchy</li>
                    <li>✓ Prominent search functionality</li>
                    <li>✓ Glassmorphism card effects</li>
                    <li>✓ Live trending searches</li>
                    <li>✓ Dual CTA buttons</li>
                  </ul>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-md">
                  <h3 className="text-xl font-semibold text-primary mb-3">Design Benefits</h3>
                  <ul className="space-y-2 text-gray-700">
                    <li>→ Builds trust with real-time stats</li>
