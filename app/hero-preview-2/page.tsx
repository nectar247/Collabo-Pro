...
import Hero3DCards from '@/components/landing/hero/Hero3DCards';
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm">Hero Concept 2: Immersive 3D Cards</p>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold text-primary mb-6">Concept 2: Immersive 3D Cards</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white rounded-xl p-6 shadow-md">
                  <h3 className="text-xl font-semibold text-primary mb-3">Key Features</h3>
                  <ul className="space-y-2 text-gray-700">
                    <li>✓ Interactive 3D card animations</li>
                    <li>✓ Parallax mouse tracking</li>
                    <li>✓ Premium search with gradient glow</li>
                    <li>✓ Floating orb animations</li>
                    <li>✓ Shine effect on hover</li>
                    <li>✓ Category deal previews</li>
                  </ul>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-md">
                  <h3 className="text-xl font-semibold text-primary mb-3">Design Benefits</h3>
                  <ul className="space-y-2 text-gray-700">
                    <li>→ Highly engaging & interactive</li>
                    <li>→ Premium, modern feel</li>
                    <li>→ Showcases deal variety</li>
                    <li>→ Eye-catching animations</li>
                    <li>→ Immersive user experience</li>
                    <li>→ Memorable first impression</li>
                  </ul>
                </div>
              </div>
            </div>
