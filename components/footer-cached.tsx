...
import { useCachedData } from "./CacheProvider";
import { FooterSingleLoading } from "./skeleton";
import { toast } from "sonner";

/**
 * Optimized Footer using cached data
 * Reduces Firestore reads from ~86 per page to 0 (after initial cache)
 */
          ...
          <div>
            ...
            <ul className="space-y-2">
              {loading ? (
                ...
                footerBrands.slice(0, 10).map((brand) => (
                  <li key={brand.id}>
                    <Link
